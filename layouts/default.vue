<template>
 <div class="mx-auto  max-w-8xl mt-20 sm:px-6 lg:px-8">
          ...
          <div v-for="randomQ in random" :key="randomQ.id"  class="relative mx-auto max-w-2xl lg:mx-0">
            ...
            <figure>
              ...
              <figcaption class="mt-6 text-base text-white">
                <div class="font-semibold">{{ randomQ.author }}</div>
              </figcaption>
            </figure>
          </div>
        </div>
...
import { useRandomQuoteQuery } from '~/queries';
 ...
 console.log("Show Data", random?.value || {})


// const {data: randomQuote} = useFetch("/api/random")
// const random = computed(()=> randomQuote?.value || {})
