<template>
  <div>
    <NuxtLink to="/" class="my-6 text-gray-500 text-center justify-center
     flex hover:text-purple-500 bg-white  hover:bg-gray-300
     border-2 w-20 mx-auto rounded-full py-4">
   <svg height="40px" id="Layer_1" style="enable-background:new 0 0 512 512;" version="1.1" viewBox="0 0 512 512" width="40px" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><polygon points="352,128.4 319.7,96 160,256 160,256 160,256 319.7,416 352,383.6 224.7,256 "/></svg>
    </NuxtLink>
    <div class="text-center">
                <p class="mt-6 text-gray-700 dark:text-gray-700"> {{ categoryName?.name }} quotes</p>
            </div>
  </div>
              ...
              <div href="#" class="relative group overflow-hidden p-8 rounded-xl bg-white border border-gray-200 dark:border-gray-800 dark:bg-gray-900">
                    ...
                    <div class="relative">
                        ...
                        <div class="mt-6 pb-6 rounded-b-[--card-border-radius] h-32">
                            <p class="text-gray-700 dark:text-gray-300">{{ quote.text }}</p>
                        </div>

                        <div class="flex gap-3 -mb-8 py-4 border-t border-gray-200 dark:border-gray-800">
                            <div class="group rounded-xl  dark:*:disabled:!text-white text-gray-950 bg-gray-100 hover:bg-gray-200/75 active:bg-gray-100 dark:text-white dark:bg-gray-500/10 dark:hover:bg-gray-500/15 dark:active:bg-gray-500/10 flex gap-1.5 items-center text-sm h-8 px-3.5 justify-center">
                                <span>{{ quote?.author}}</span>
                            </div>
                            <button @click="copyQuote(quote?.text, quote?.author, quote?.id)" class="text-center flex justify-center items-center">
                             <svg enable-background="new 0 0 512 512"  height="20px" id="Layer_1" version="1.1" viewBox="0 0 512 512" width="20px" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><path d="M468.493,101.637L371.955,5.098H159.57v77.231H43.724v424.769h308.923v-77.231h115.846V101.637z   M371.955,32.401l69.236,69.235h-69.236V32.401z M63.031,487.79V101.637h173.769v96.538h96.538V487.79H63.031z M256.108,109.632  l69.236,69.235h-69.236V109.632z M352.647,410.56V178.867l-96.538-96.538h-77.231V24.406h173.769v96.538h96.538V410.56H352.647z" fill="#37404D"/></svg>
                            </button>
                        </div>
...
const copyQuote = (quoteText: Ref<string>, quoteAuthor: Ref<string>, quoteId: any) => {
